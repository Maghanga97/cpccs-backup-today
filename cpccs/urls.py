...
from incidents.views import  incident_pdf, overall_report, search_incident, search_results, department_incidents_types, incidents_view, incidents_types, incidents_list, department_incidents, registration_view, add_department, manage_users, admin_view, details, edit_user_view, main_admin_panel, login
...
urlpatterns = [
    ...
    path('search/<clicked_from>/<user_id>/', search_incident),
